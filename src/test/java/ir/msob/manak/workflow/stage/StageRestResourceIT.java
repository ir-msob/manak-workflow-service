...
@Testcontainers
@CommonsLog
public class StageRestResourceIT
        extends DomainCrudRestResourceTest<Stage, StageDto, StageCriteria, StageRepository, StageService, StageDataProvider>
    ...
    public Class<? extends BaseResource<String, User>> getResourceClass() {
        return StageRestResource.class;
    }
