...
@Testcontainers
@CommonsLog
public class StageCharacteristicRestResourceIT
        extends BaseCharacteristicCrudRestResourceTest<Stage, StageDto, StageCriteria, StageRepository, StageService, StageDataProvider, StageService, StageCharacteristicCrudDataProvider>
    ...
    public void beforeEach() {
        ...
        StageCharacteristicCrudDataProvider.createNewChild();
    }


    @Override
    public String getBaseUri() {
        return StageRestResource.BASE_URI;
    }

    @Override
    public Class<? extends BaseResource<String, User>> getResourceClass() {
        return StageCharacteristicRestResource.class;
    }
}
